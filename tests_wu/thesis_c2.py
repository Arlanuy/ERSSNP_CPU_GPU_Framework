...
__global__ void lc_substring(int i,int *X,int *Y, int *LCSuff,int col_width){
...
b = numpy.array([0,0,0,0,0,0],dtype=numpy.int32) #col
...
for i in range(a.size+1):
	LCS(numpy.int32(i),a_gpu,b_gpu,LCSuff_gpu,numpy.int32(b.size+1), block=(10,10,1),grid=(1,1,1))
