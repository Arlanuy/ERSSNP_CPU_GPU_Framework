...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gorminload” 
#SBATCH --output=gorminload.%J.out 

#SBATCH --error=gorminload.%J.err 
...
srun python main.py 2 2 3 gpuorminimal00.yaml 2gpuorminimal00.yaml 2gpuorminimal00outreal.yaml
