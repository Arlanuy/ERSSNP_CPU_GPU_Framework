...
#SBATCH --mem=24G 
#SBATCH --job-name=”csubminsave” 
#SBATCH --output=csubminsave.%J.out 

#SBATCH --error=csubminsave.%J.err 
...
srun python main.py 1 5 1 5 12 40 1 0 0 cpusubminimal00.yaml cpusubminimal00outreal.yaml
