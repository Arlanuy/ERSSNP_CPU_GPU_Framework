...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gnotminload” 
#SBATCH --output=gnotminload.%J.out 

#SBATCH --error=gnotminload.%J.err 
...
srun python main.py 2 2 1 cpunotminimal00.yaml 2gpunotminimal00.yaml 2gpunotminimal00outreal.yaml
