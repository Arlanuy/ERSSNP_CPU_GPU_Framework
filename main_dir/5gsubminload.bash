...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gsubminload” 
#SBATCH --output=gsubminload.%J.out 

#SBATCH --error=gsubminload.%J.err 
...
srun python main.py 2 2 1 cpusubminimal00.yaml 5gpusubminimal00.yaml 5gpusubminimal00outreal.yaml
