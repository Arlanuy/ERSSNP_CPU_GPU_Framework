...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gandextraload” 
#SBATCH --output=gandextraload.%J.out 

#SBATCH --error=gandextraload.%J.err 
...
srun python main.py 2 2 5 cpuandextra22.yaml gpuandextra22.yaml gpuandextra22outreal.yaml
