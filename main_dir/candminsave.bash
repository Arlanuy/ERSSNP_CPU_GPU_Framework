...
#SBATCH --mem=24G 
#SBATCH --job-name=”candminsave” 
#SBATCH --output=candminsave.%J.out 

#SBATCH --error=candminsave.%J.err 
...
srun python main.py 1 1 1 5 12 40 1 0 0 cpuandminimal00.yaml cpuandminimal00outreal.yaml
