...
#SBATCH --mem=24G 
#SBATCH --job-name=”corminsave” 
#SBATCH --output=corminsave.%J.out 

#SBATCH --error=corminsave.%J.err 
...
srun python main.py 1 2 1 5 12 40 1 0 0 cpuorminimal00.yaml cpuorminimal00outreal.yaml
