...
#SBATCH --mem=24G 
#SBATCH --job-name=”2csubextrasave” 
#SBATCH --output=csubextrasave.%J.out 

#SBATCH --error=csubextrasave.%J.err 
...
srun python main.py 1 5 3 5 12 40 1 2 2 9cpusubextra22.yaml 9cpusubextra22outreal.yaml
