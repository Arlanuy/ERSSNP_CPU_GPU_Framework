...
#SBATCH --mem=24G 
#SBATCH --job-name=”cnotextrasave” 
#SBATCH --output=cnotextrasave.%J.out 

#SBATCH --error=cnotextrasave.%J.err 
...
srun python main.py 1 3 3 5 12 40 1 2 2 cpunotextra22.yaml cpunotextra22outreal.yaml
