...
#SBATCH --mem=24G 
#SBATCH --job-name=”candextrasave” 
#SBATCH --output=candextrasave.%J.out 

#SBATCH --error=candextrasave.%J.err 
...
srun python main.py 1 1 3 5 12 40 1 2 2 cpuandextra22.yaml cpuandextra22outreal.yaml
