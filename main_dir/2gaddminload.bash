...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gaddminload” 
#SBATCH --output=gaddminload.%J.out 

#SBATCH --error=gaddminload.%J.err 
...
srun python main.py 2 2 2 cpuaddminimal00.yaml 2gpuaddminimal00.yaml 2gpuaddminimal00outreal.yaml
