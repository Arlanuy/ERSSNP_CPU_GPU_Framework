...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gorextraload” 
#SBATCH --output=gorextraload.%J.out 

#SBATCH --error=gorextraload.%J.err 
...
srun python main.py 2 2 5 cpuorextra22.yaml gpuorextra22.yaml gpuorextra22outreal.yaml
