...
#SBATCH --mem=24G 
#SBATCH --job-name=”cnotadvsave” 
#SBATCH --output=cnotadvsave.%J.out 

#SBATCH --error=cnotadvsave.%J.err 
...
srun python main.py 1 3 2 5 12 40 1 1 1 cpunotadversarial11.yaml cpunotadversarial11outreal.yaml
