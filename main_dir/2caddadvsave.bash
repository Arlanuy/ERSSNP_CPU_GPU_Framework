...
#SBATCH --mem=24G 
#SBATCH --job-name=”caddadvsave” 
#SBATCH --output=caddadvsave.%J.out 

#SBATCH --error=caddadvsave.%J.err 
...
srun python main.py 1 4 2 5 12 40 1 1 1 2cpuaddadversarial11.yaml 2cpuaddadversarial11outreal.yaml
