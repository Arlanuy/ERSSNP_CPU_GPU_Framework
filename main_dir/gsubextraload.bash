...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gsubextraload” 
#SBATCH --output=gsubextraload.%J.out 

#SBATCH --error=gsubextraload.%J.err 
...
srun python main.py 2 2 5 4gpusubextra22.yaml 5gpusubextra22.yaml 5gpusubextra22outreal.yaml
