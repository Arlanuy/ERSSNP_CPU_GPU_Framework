...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gaddextraload” 
#SBATCH --output=gaddextraload.%J.out 

#SBATCH --error=gaddextraload.%J.err 
...
srun python main.py 2 2 5 cpuaddextra22.yaml gpuaddextra22.yaml gpuaddextra22outreal.yaml
