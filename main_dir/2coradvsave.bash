...
#SBATCH --mem=24G 
#SBATCH --job-name=”2coradvsave” 
#SBATCH --output=coradvsave.%J.out 

#SBATCH --error=coradvsave.%J.err 
...
srun python main.py 1 2 2 5 12 40 1 1 1 2cpuoradversarial11.yaml 2cpuoradversarial11outreal.yaml
