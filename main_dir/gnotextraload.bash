...
#SBATCH --overcommit
#SBATCH --mem=12G 
#SBATCH --job-name=”gnotextraload” 
#SBATCH --output=gnotextraload.%J.out 

#SBATCH --error=gnotextraload.%J.err 
...
srun python main.py 2 2 5 cpunotextra22.yaml gpunotextra22.yaml gpunotextra22outreal.yaml
