...
#SBATCH --mem=24G 
#SBATCH --job-name=”corextrasave” 
#SBATCH --output=corextrasave.%J.out 

#SBATCH --error=corextrasave.%J.err 
...
srun python main.py 1 2 3 5 12 40 1 2 2 cpuorextra22.yaml cpuorextra22outreal.yaml
