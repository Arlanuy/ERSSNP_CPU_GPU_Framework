...
#SBATCH --mem=24G 
#SBATCH --job-name=”candadvsave” 
#SBATCH --output=candadvsave.%J.out 

#SBATCH --error=candadvsave.%J.err 
...
srun python main.py 1 1 2 5 12 40 1 1 1 cpuandadversarial11.yaml cpuandadversarial11outreal.yaml
